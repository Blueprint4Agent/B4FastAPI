...
class RedisTaskQueueWorker:
    ...
    async def enqueue(self, *, task_type: str, payload: TaskPayload) -> None:
    ...
    def _decode_envelope(self, raw_payload: str) -> dict[str, object] | None:
        try:
    ...
    async def _process_envelope(self, envelope: dict[str, object]) -> None:
