...
export function SignupEmailSentPage() {
  ...
  return (
    <main className="page">
      <ThemeToggle />
      <PanelCard
        title={showAccountCreated ? t("signupEmailSent.accountCreatedTitle") : t("signupEmailSent.title")}
        subtitle={
          showAccountCreated
            ? t("signupEmailSent.accountCreatedSubtitle")
            : t("signupEmailSent.subtitle", { email: email || t("signupEmailSent.noEmail") })
        }
      >
        {showAccountCreated ? (
          <InfoCard
          ...
          <>
            <p className="muted signup-email-sent__description">{t("signupEmailSent.description")}</p>
            {resendMessage ? (
