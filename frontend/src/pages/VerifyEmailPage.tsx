...
export function VerifyEmailPage() {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      try {
        ...
        setStatus("error");
        setErrorMessage(detail?.message || detail?.error || t("verifyEmail.errors.fallback"));
      }
    };
  ...
  if (status === "error") {
    return (
      <main className="page">
        <ThemeToggle />
        <PanelCard title={t("verifyEmail.errorTitle")} subtitle={t("verifyEmail.errorSubtitle")}>
          <ErrorCard
  ...
  return (
    <main className="page">
      <ThemeToggle />
      <PanelCard title={t("verifyEmail.successTitle")} subtitle={t("verifyEmail.successSubtitle")}>
