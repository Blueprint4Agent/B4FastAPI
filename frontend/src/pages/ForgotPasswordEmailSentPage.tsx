  ...
  return (
    <main className="page">
      ...
      <PanelCard
        title={
          showDisabled
            ? t("forgotPassword.disabledTitle")
            : t("forgotPassword.sentTitle")
        }
        subtitle={
          showDisabled
            ? t("forgotPassword.disabled")
            : t("forgotPassword.sentSubtitle", { email: email || t("forgotPassword.noEmail") })
        }
      >
        {showDisabled ? (
          <WarningCard title={t("cards.warningTitle")} message={t("forgotPassword.disabled")} />
        ) : (
          <InfoCard title={t("cards.infoTitle")} message={t("forgotPassword.sentDescription")} />
        )}
