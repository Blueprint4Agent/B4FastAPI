...
UI에는 앱 Nav 프로필 또는 standalone 타이틀바 테마 컨트롤 옆에 compact 오프라인 상태를
...
해결을 제공하지 않습니다.
랜딩 및 서버 연결 불가 페이지는 중앙 제목과 테마 컨트롤이 있는 동일한 public Nav를
사용합니다. 대칭 Nav column과 고정 연결 상태 폭을 사용해 재시도 중 상태 문구가 바뀌어도
