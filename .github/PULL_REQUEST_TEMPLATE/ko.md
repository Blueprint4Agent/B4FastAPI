...
- PR 제목은 `[type] Concise title` 형식을 사용합니다. 예: `[feat] Add API key pagination`
- 브랜치는 `<type>/<short-kebab-title>` 형식을 사용합니다. 예: `feat/api-key-pagination`
...
- 워크로그 경로:
- 설계와 관련 루프 또는 해당 없음 사유:
- 실행한 검사와 이번 작업에서 생략한 검사·사유:
